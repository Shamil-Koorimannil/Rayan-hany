...
export default function MindsetSection() {
  ...
  return (
    ...
    >
      {/* Deco: search/research circle top-right */}
      <div className="absolute top-10 right-[3%] z-20 rotate-[16deg] hidden lg:flex w-14 h-14 bg-[#319C97] border-[3px] border-[#222222] rounded-full shadow-[5px_5px_0px_0px_#222222] items-center justify-center hover:scale-110 transition-transform duration-150">
        <span className="text-white text-lg font-black">🔍</span>
      </div>
      {/* Deco: "PROCESS" pill bottom-left */}
      <div className="absolute bottom-10 left-[2%] z-20 rotate-[-8deg] hidden lg:flex items-center px-3 py-2 bg-[#8A63D2] border-[3px] border-[#222222] rounded-full shadow-[4px_4px_0px_0px_#222222] hover:scale-110 transition-transform duration-150">
        <span className="text-[10px] font-black uppercase tracking-widest text-white">PROCESS</span>
      </div>
      {/* Deco: eye badge top-left */}
      <div className="absolute top-8 left-[2%] z-20 rotate-[-14deg] hidden lg:flex w-12 h-12 bg-[#FFD45C] border-[3px] border-[#222222] rounded-xl shadow-[4px_4px_0px_0px_#222222] items-center justify-center hover:scale-110 transition-transform duration-150">
